...
export default function Navbar({ isCollapsed, onToggle }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Fixed Sidebar */}
      <nav
        className={`fixed top-0 left-0 bottom-0 z-40 w-64 bg-[var(--bg-surface)] border-r border-[var(--border-subtle)] flex flex-col transition-transform duration-300 ${isCollapsed ? "-translate-x-full" : "translate-x-0"
          }`}
      >
        ...
        <div className="px-6 py-6 border-b border-[var(--border-subtle)] flex items-center justify-between">
          ...
          <button
            onClick={onToggle}
            className="p-2 bg-[var(--bg-elevated)] hover:bg-[var(--bg-muted)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] rounded-lg border border-[var(--border-default)] transition-all"
        ...
        <div className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
          ...
          <Link
            to="/"
            className="flex items-center px-4 py-3 text-sm font-medium text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-elevated)] rounded-xl transition-all"
          >
        ...
        <div className="px-4 py-4 border-t" style={{ borderColor: "var(--border-subtle)" }}>
          {isAuthenticated ? (
            <div className="space-y-3">
              ...
              <div className="px-4 py-2">
                <p className="text-xs text-[var(--text-subtle)] uppercase tracking-wider">Signed in as</p>
              ...
              <button
                ...
                className="w-full flex items-center justify-center px-4 py-3 border border-[var(--border-default)] text-sm font-medium rounded-xl text-[var(--text-secondary)] bg-[var(--bg-elevated)] hover:bg-[var(--bg-muted)] hover:text-[var(--text-primary)] transition-all"
              >
            ...
            <Link
              to="/auth"
              className="w-full flex items-center justify-center px-4 py-3 border border-transparent text-sm font-medium rounded-xl text-[var(--text-primary)] bg-[var(--accent)] hover:bg-[var(--accent-hover)] shadow-lg shadow-[var(--accent-shadow)] transition-all"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
