...
%----------------------------------------------------------------------------------------
\documentclass[english,12pt,a4paper,openany,oneside]{book}
\usepackage{datetime}
\usepackage{tabularx}
\usepackage{makecell}
\usepackage{eurosym}
...
\lstset{
    ...
    tabsize=4,
    morekeywords={var, String, Long, LocalDateTime},
}
...
\newcommand{\reportauthor}{Ariel C. Nunes} % Change to your name
\newcommand{\projecttitle}{TRiM - A Multi Tenant SaaS Application}
