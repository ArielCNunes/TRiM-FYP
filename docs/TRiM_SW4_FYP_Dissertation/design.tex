...
\subsection{Migration From Single Tenant to Multi Tenant}
\subsection{TenantFilter}
\subsection{TenantContext (ThreadLocal)}
\subsection{Subdomain-based Routing}
\subsection{Database Optimisation}

\section{Availability Algorithm}
\subsection{Preventing Race Conditions}
\subsection{Slot Calculation}

\section{Security Architecture}
\subsection{Cross-subdomain Token Exchange}

\section{Deposit Calculation}
